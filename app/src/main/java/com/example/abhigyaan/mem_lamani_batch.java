...
public class mem_lamani_batch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mem_lamani_batch);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("itemslam");
