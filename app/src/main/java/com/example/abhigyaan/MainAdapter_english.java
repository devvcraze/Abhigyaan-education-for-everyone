...
public class MainAdapter_english extends FirebaseRecyclerAdapter<MainModel_disha, MainAdapter_english.myViewHolder> {
    private boolean toastShown = false;

    public MainAdapter_english(@NonNull FirebaseRecyclerOptions<MainModel_disha> options) {
        super(options);
    }
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                FirebaseDatabase.getInstance().getReference().child("UPdations_english")
