...
public class RequestAdapterlam extends RecyclerView.Adapter<RequestAdapterlam.RequestViewHolder> {

    private Context context;
    private List<Request> requestList;

    public RequestAdapterlam(Context context, List<Request> requestList) {
    ...
    private void updateRequestAcceptance(Request request, boolean isAccepted, String acceptedBy) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("requestslam").child(request.getId());
