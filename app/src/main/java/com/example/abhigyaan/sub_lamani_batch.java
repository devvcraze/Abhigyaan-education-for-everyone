...
public class sub_lamani_batch extends AppCompatActivity {

    private RecyclerView recyclerView;
    private RequestAdapterlam requestAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_lamani_batch);
        ...
        requestAdapter = new RequestAdapterlam(this, requestList);

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(requestAdapter);

        databaseReference = FirebaseDatabase.getInstance().getReference("requestslam");
    ...
    private void loadRequestsFromFirebase() {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(sub_lamani_batch.this, "Failed to load requests", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        builder.setTitle("Add Request")
                .setPositiveButton("Add", (dialog, which) -> {
                    ...
                    if (name.isEmpty() || whatsappNumber.isEmpty() || dateTime.isEmpty() || reason.isEmpty()) {
                        Toast.makeText(sub_lamani_batch.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                    } else {
        ...
        if (id != null) {
            ...
            databaseReference.child(id).setValue(request).addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    Toast.makeText(sub_lamani_batch.this, "Request added", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(sub_lamani_batch.this, "Failed to add request", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
