...
public class RequestAdaptermes extends RecyclerView.Adapter<RequestAdaptermes.RequestViewHolder> {

    private Context context;
    private List<Request> requestList;

    public RequestAdaptermes(Context context, List<Request> requestList) {
    ...
    private void updateRequestAcceptance(Request request, boolean isAccepted, String acceptedBy) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("requestsmes").child(request.getId());
