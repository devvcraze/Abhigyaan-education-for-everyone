...
public class RequestAdaptereng extends RecyclerView.Adapter<RequestAdaptereng.RequestViewHolder> {

    private Context context;
    private List<Request> requestList;

    public RequestAdaptereng(Context context, List<Request> requestList) {
    ...
    private void updateRequestAcceptance(Request request, boolean isAccepted, String acceptedBy) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("requestseng").child(request.getId());
